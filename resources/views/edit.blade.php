                ...
                <form action="{{ route('update',['id'=>$products->id]) }}" method="post" enctype="multipart/form-data">
                    @csrf
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">       
                                <input type="text" class="form-control" id="product_name" name="product_name" placeholder="Name" value="{{old('name',$products->product_name)}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="stock" name="stock" placeholder="0" value="{{old('name',$products->stock)}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input class="form-control" id="price" name="price" placeholder="Price" value="{{old('name',$products->price)}}"></input>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                            <textarea class="form-control" id="comment" name="comment" >{{old('name',$products->comment)}}</textarea>
                            </div>
                            
                        </div>
            
                        <div class="form-group row">
                            <label for="img"class="col-md-4 col-form-label text-md-right">{{ __('写真') }}</label>
